...
function printIndexes(array) {
  for (const point in array) // Проходимося по всіх індексах масиву
    console.log(point); // Виводимо кожен індекс на консоль
}
...
function multiplyArray(array) {
  let total = 1; // Ініціалізуємо змінну для зберігання добутку
  for (const point of array) {
    // Проходимося по всіх значеннях масиву
    total *= point; // Множимо кожен елемент на загальний добуток
    // Повертаємо добуток
  }
  return total;
}
...
function modifyArray(array) {
  delete array[2];
  console.log(array.toString()); // Видаляємо третій елемент масиву
...
function findMinMax([firstElement, ...restElements]) {
  ...
  let max = firstElement; // Ініціалізуємо змінні для мінімального та максимального значень, задаємо їм перше значення масиву
...
function printStrings(array) {
  console.log(array.toString().repeat(2)); // Перетворюємо масив в рядок і видаляемо пробіли та виводимо його на консоль
}
...
function swapMinMax(array) {
  let min = array[0]; // Ініціалізуємо дві змінні (max і min) з першим елементом масиву. Ці змінні будуть використовуватися для зберігання максимального та мінімального значень в масиві.
  let max = array[0];
...
// Завдання 11: Функція приймає масив чисел. Поверніть новий масив, який містить
// тільки парні числа з оригінального масиву.

function getEvenNumbers(arr) {
  let evenArray = []; // Створюємо пустий масив для зберігання результату
  for (const evenNumber of arr) {
    if (evenNumber % 2 === 0) {
...
function multiplyByIndex(arr) {
  let newArray = []; // Створюємо пустий масив для зберігання результату
